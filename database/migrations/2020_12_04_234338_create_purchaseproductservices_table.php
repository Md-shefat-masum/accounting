...
class CreatePurchaseproductservicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchaseproductservices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchaseproductservices');
    }
}
