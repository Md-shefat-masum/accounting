<template>
    ...
    <!-- form section -->
    <form @submit.prevent="createCfagetn">
                        ...
                        <div class="container-fluid A54VNK-Ae-e">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12" >
                                            <div class="form-group floating-label mandatory" :class="{ 'has-error': form.errors.has('company_name') }">
                                                ...
                                                <label class="control-label form-question ellipsis" for="gwt-uid-384">Company Name / C&F Name</label>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group floating-label">
                                                ...
                                                <label class="control-label form-question ellipsis" for="gwt-uid-467">C&F License Number</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-9 col-md-8">
                                            ...
                                            <div class="row A54VNK-uc-a">
                                                ...
                                                <div class="col-6 text-right">
                                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                        <label v-on:click="form.working_port = true" class="btn btn-default" v-bind:class="{ active: form.working_port }" for='option1' style="text-transform: capitalize;">
                                                            <input type="radio" id="option1" value="true" v-model="form.working_port">Yes
                                                        </label>
                                                        <label v-on:click="form.working_port = false" class="btn btn-default" v-bind:class="{ active: !form.working_port }" for='option2' style="text-transform: capitalize;">
                                                            <input type="radio" id="option2" value="false" v-model="form.working_port">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" v-if="!form.working_port">
                                            <div class="col-12">
                                                <div>
                                                    <span></span>
                                                    <div>
                                                        <div class="row" v-for="(port_addres, k) in form.delivery_address" :key="k">
                                                            <div class="col-11">
                                                                <div class="form-group floating-label">
                                                                    ...
                                                                    <label class="control-label form-question ellipsis" :for="k">Port address</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-1 text-right object-list-last-cell A54VNK-Pg-a" style="display: flex;align-items: center;">
                                                                <button @click="removePortAddressRow(k, port_addres)" type="button" class="btn btn-danger A54VNK-Pg-b">
                                    ...
                                    <button v-if="!form.working_port" @click="addPortAddressRow()" type="button" class="btn btn-default A54VNK-Ef-a" style="text-transform: capitalize;">Add Another Port</button>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="A54VNK-Ef-b">
                                                ...
                                                <button @click="addContactListRow()" type="button" class="btn btn-default A54VNK-Ef-a"  style="text-transform: capitalize;">New C&F Agent Contact</button>
                                            </div>
                                        </div>
                            ...
                            <hr> <a class="accordion-toggle collapsed A54VNK-Ae-a" data-toggle="collapse" href="#gwt-uid-708">Advanced</a>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createCfagetn: function () {
                this.form.post('/api/cfagetns').then(() => {
                    Toast.fire({
                        icon: 'success',
            ...
            removePortAddressRow(k, delivery_address) {
                if (k > -1) {
