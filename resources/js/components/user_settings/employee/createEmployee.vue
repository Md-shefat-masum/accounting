            ...
            <form action="">
                ...
                <div class="row">
                    <div class="form-group floating-label mandatory col-md-6 px-2">
                        ...
                        <label for="gwt-uid-380" class="control-label form-question ellipsis">First Name</label>
                    </div>
                    <div class="form-group floating-label mandatory col-md-6 px-2">
                        <input type="text" id="gwt-uid-381" autocomplete="off" class="form-control form-component" />
                        <label for="gwt-uid-381" class="control-label form-question ellipsis">Last Name</label>
                    </div>
                    <div class="form-group floating-label mandatory col-md-6 px-2">
