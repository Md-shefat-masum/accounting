                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <ul class="breadcrumb breadcrumb-style d-inline-block mb-0">
                                <li class="breadcrumb-item">
                                    <h4 style="border: 0;" class="page-title">Supplier Quotes</h4>
                                </li>
                            </ul>
                            <ul class="d-inline-block mb-0" style="float: right;padding: .75rem 1rem;">
                                <li style="float: left;">
                                    <router-link to="/purchase/supplier-quote/create" class="btn btn-default m-0 mr-2 mb-2 mb-lg-0 mobile_d_none">
                                        New Supplier Quote
                                    </router-link>
    ...
    export default {
        ...
        methods: {
            getResults(page = 1) {
                ...
                axios.get(`/api/supplierquotes?status=`+status+'&page=' + page)
                    .then(response => {
            ...
            listQuotes: function (status) {
                ...
                this.form.get(`/api/supplierquotes?status=`+status).then(function (response) {
            ...
            createQuote: function () {
                var that = this;
                this.form.post('/api/quotes')
                    .then(function (response) {
                        that.quotes.push(response.data);
                        that.form.reset();
                    }).catch((err)=>{
                        console.log(err,'asdflas');
                    })
            },
            editQuote: function(print_quote_id){
                this.$router.replace({ name: 'editQuote', params: { id: print_quote_id }});
            },
