    ...
    <div class="submenu card content-card">
        <div class="body">
            ...
            <ul class="nav nav-tabs tab-nav-right text-center">
                <li>
                    <router-link to="/accounting/bank-activitys">Bank Activity</router-link>
                </li>
                <li>
                    <router-link to="/accounting/chart-of-accounts">Chart Of Accounts </router-link>
                </li>
                <li class="mobile_d_none">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <router-link class="dropdown-item" to="/accounting/accounting-transactions">Accounting Transactions</router-link>
                        <router-link class="dropdown-item" to="/accounting/bank-deposits">Bank Deposit</router-link>
                        <router-link class="dropdown-item" to="/accounting/bank-transfers">Bank Transfers</router-link>
                        <router-link class="dropdown-item" to="/accounting/accounting-receipts">View Accounting Receipts</router-link>
                    </div>
                </li>
            </ul>
            <!-- Tab panes -->
