                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <ul class="breadcrumb breadcrumb-style d-inline-block mb-0">
                                <li class="breadcrumb-item">
                                    <h4 style="border: 0;" class="page-title">Bank Transfers</h4>
                                </li>
                            </ul>
                            <ul class="d-inline-block mb-0" style="float: right;padding: .75rem 1rem;">
                                <li style="float: left;">
                                    <router-link to="/accounting/bank-transfer/create" class="btn btn-default m-0 mr-2 mb-2 mb-lg-0 mobile_d_none">Make Bank Transfer</router-link>
                                    <router-link to="/accounting/bank-transfer/create" class="btn btn-default m-0 mr-2 mb-2 mb-lg-0 mobile_d_block"><i class="fas fa-plus"></i></router-link>
                                </li>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 155px;">Bank Transfer</th>
                                        <th style="min-width: 155px;">Description</th>
                                        <th class="text-right" style="min-width: 120px;">From</th>
                                        <th class="text-right" style="min-width: 120px;">Amount</th>
                                        <th class="text-center" style="min-width: 120px;">To</th>
