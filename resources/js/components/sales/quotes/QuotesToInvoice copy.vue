...
<!--                                                                                </li>-->
                                                    ...
                                                    <div data-id="v192168000062_1318947754064_656">
                                                        <div class="form-horizontal">
                                                            ...
                                                            <!-- <div class="form-group row" data-id="v192168000062_1318947796381_657">
                                                                ...
                                                                <div class="col-sm-8 col-8">
                                                                    <div class="dropdown">
                                                                        <textarea class="form-control" rows="4" v-model="form.delivery_notes"
                                                                        style="resize: vertical; min-height: 50px;"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div> -->
                                    ...
                                    <salesStatusVue v-if="sales_logs" :sales_logs="sales_logs"></salesStatusVue>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" @click="toggleProductServiceOrExpense('porduct_service')" data-toggle="tab"
                                                                href="#"
                                                                aria-selected="true">Product and Services</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" @click="toggleProductServiceOrExpense('expense')" data-toggle="tab"
                                                                href="#"
                                                ...
                                                <div class="col-sm-12">
                                                    <div data-id="v192168000062_1318948822365_260">
                                                            ...
                                                            <div>
                                                                <table class="A54VNK-Ff-y table table-hover table-link A54VNK-Ff-z empty" cellspacing="0" style="table-layout: fixed;">
                                                                    ...
                                                                    <tbody v-if="selected_products">
                                                                        <tr @click="product_selected_row(selected_product.id,$event)"
                                                                            class="A54VNK-Ff-r product_seleted_row"
                                                                            v-for="selected_product in selected_products"
                                                                            :key="selected_product.id+(Math.random())">
                                                        ...
                                                        <div class="btn-toolbar A54VNK-Ki-a">
                                                            <button type="button" @click="productListRender()" data-toggle="modal" data-target="#addProductOrService" class="btn btn-default mt-2">
                                    ...
                                    <div class="modal fade" id="addProductOrService" tabindex="-1" aria-labelledby="addProductOrServiceLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <listOfProductOrServiceVue :key="product_random_number"
...
<script>
    ...
    export default {
        ...
        created: function () {
            ...
            setTimeout(() => {
                $('.edit_head_text').text('Quote to invoice.');
            }, 300);
        },
        methods: {
            getQuote: function () {
                var that = this;
                this.form.get('/api/quotes/' + this.$route.params.id).then(function (response) {
            ...
            createInvoice: function(){
                let quote_update_data = new FormData();
                quote_update_data.append('id',this.$route.params.id);
                quote_update_data.append('status','won');
                // axios.post('/api/update_qutation_status',quote_update_data)
                //     .then((res)=>{
                //         console.log(res);
                //     })
            ...
            calculateProductDiscount: function(product_id){
                ...
                //     element.total_price = sales_price*element.qty;
                //     this.selected_products[key] = element;
                // }
