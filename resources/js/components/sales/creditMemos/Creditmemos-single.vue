<template>
    ...
    <form @submit.prevent="createCreditmemo">
                                ...
                                <div class="col-sm-12">
                                    <table class="A54VNK-Ff-y table table-hover table-link A54VNK-Ff-z empty"
                                        ...
                                        <tbody v-if="selected_products">
                                            <tr @click="product_selected_row(selected_product.id,$event)" class="A54VNK-Ff-r product_seleted_row" v-for="(selected_product,index) in selected_products" :key="index">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteCreditmemo: function () {

                var that = this;
                this.form.delete('/api/creditmemos/' + this.$route.params.id).then(function (response) {
                    that.form.fill(response.data);
                    that.$router.push('/super-admin/creditmemos');
                })
