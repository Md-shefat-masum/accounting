...
<!--                                                                                </li>-->
                                                                            <li class="active">
                                                                                <a class="ellipsis-block"  @click="customerListRender()" role="button" data-toggle="modal" data-target="#listOfCustomerOrLeadModal">View all Leads and Customers</a>
                                                                            </li>
                                                                            <li class="">
                                                                ...
                                                                <div class="col-sm-8 col-8">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <ul class="dropdown-menu A54VNK-oi-a">
                                                                            <li class="active p-0">
                                                                                <a class="ellipsis-block" @click="form.status = 'delivered'" role="button">delivered</a>
                                                                            </li>
                                                                            <li class="p-0">
                                                                                <a class="ellipsis-block" @click="form.status = 'partially delivered'" role="button">partially delivered</a>
                                                                            </li>
                                                                            <li class="p-0">
                                                                                <a class="ellipsis-block" @click="form.status = 'close'" role="button">Close</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
