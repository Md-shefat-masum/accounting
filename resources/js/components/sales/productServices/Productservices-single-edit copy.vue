                            ...
                            <div class="row">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="row form-group A54VNK-Ae-j">
                                            <div class="col-12 col-sm-6">
                                                <div class="btn-group A54VNK-tc-c " aria-atomic="true">
                                                    <a v-bind:class="{ active: check_service }"
                                                        class='btn btn-default'
                                                        @click="toggle_is_service"
                                                        style="text-transform: capitalize;">Service</a>

                                                    <a v-bind:class="{ active: !check_service }"
                                                        class='btn btn-default' @click="toggle_is_service"
                                                        style="text-transform: capitalize;">Product</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <unit-dropdown :old_unit_name="form.unit"></unit-dropdown>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-2 align-items-center d-flex justify-content-end tl">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn active btn-default" @click="toggle_inventory" for='option1' style="text-transform: capitalize;">
                                                        <input type="radio" checked=''>Yes
                                                    </label>
                                                    <label class="btn btn-default" @click="toggle_inventory" for='option2' style="text-transform: capitalize;">
                                                        <input type="radio">No
                                                    </label>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-11">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="dropdown">
                                                        <input type="text" v-model="form.receiving_location" class="form-control A54VNK-oi-b" data-toggle="dropdown" autocomplete="off" role="button" placeholder="Search results" id="gwt-uid-161" aria-expanded="false">
                                                        <ul class="dropdown-menu A54VNK-oi-a">
                                                            ...
                                                            <li class="">
                                                                <a class="ellipsis-block" data-toggle="modal" data-target="#addProductReciveModal" role="button">Create a new...</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="dropdown">
                                                        <input type="text" class="form-control A54VNK-oi-b" v-model="form.picking_delivery_location" data-toggle="dropdown" autocomplete="off" role="button" placeholder="Search results" id="gwt-uid-161" aria-expanded="false">
                                                        <ul class="dropdown-menu A54VNK-oi-a">
        ...
        methods: {
            getServiceSingle: function (Customers) {
                ...
                this.form.get('/api/productservices/' + this.$route.params.id).then(function (response) {
                    ...
                    if(response.data.is_services){
                        that.check_service = 1;
                    }else{
                        that.check_service = 0;
                    }

                    if(response.data.is_track_inventory){
                        that.is_inventory = 1;
                    }else{
                        that.is_inventory = 0;
                    }
