...
<!--                                                                                </li>-->
                                                                ...
                                                                <div class="form-group row" data-id="v010010010010_1249894205531_1038">
                                                                    <div class="col-sm-4 col-4 control-label"><label class="" style="font-weight: normal;">Currency</label></div>
                                                                    <div class="col-sm-8 col-8">
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <div class="A54VNK-ni-a">
                                                                            ...
                                                                            <div class="col-6">
                                                                                <input type="text" v-model="form.exchange_rate" class="form-control A54VNK-oi-b" placeholder="Exchange Rate" style="height: 33px;">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div data-id="v192168000062_1318948822365_260">
                                                        ...
                                                        <div class="btn-toolbar A54VNK-Ki-a">
                                                            <button type="button" data-toggle="modal" data-target="#addProductOrService" class="btn btn-default mt-2">
                                                                                    ...
                                                                                    <div class="col-sm-8 col-8">
                                                                                        <div class="dropdown">
                                                                                            ...
                                                                                            <!-- <ul class="dropdown-menu A54VNK-pi-c">
                                                                                                <li class="active">
                                                                                                    <a class="ellipsis-block"
                                                                                                       role="button">deliveryContact.first_name
                                                                                                                     deliveryContact.last_name</a>
                                                                                                </li>
                                                                                                <li class="divider"></li>
                                                                                                <li class="active"><a
                                                                                    ...
                                                                                    <div class="col-sm-8 col-8">
                                                                                        <div class="dropdown">
                                                                                            ...
                                                                                            <!-- <ul class="dropdown-menu A54VNK-pi-c">
                                                                                                <li class="active">
                                                                                                    <a class="ellipsis-block"
                                                                                                       role="button">address.delivery_address</a>
                                                                                                </li>
                                                                                                <li class="disabled"><a>
                                                                                                    No result </a></li>
                                                                                                <li class="divider"></li>
    ...
    export default {
        ...
        methods: {
            getInvoice: function () {
                ...
                this.form.get('/api/delivery-note/' + this.$route.params.id).then(function (response) {
