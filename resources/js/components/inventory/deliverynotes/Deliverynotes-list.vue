                                            ...
                                            <div class="dropdown d-inline-block">
                                                <div class="btn-group dropleft text-center">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item waves-effect waves-light"
                                                        href="#" @click="printData(deliverynote.id)">Print</a>
                                                        <hr style="margin: 2px 0;">
                                                        <a class="dropdown-item waves-effect waves-light"
                                                        @click="DeliveryNotesToInvoice(deliverynote.id)" href="#">Convert to Invoice</a>
                                                        <hr style="margin: 2px 0;">
                                                        <a class="dropdown-item waves-effect waves-light"
    ...
    export default {
        ...
        methods: {
            ...
            createDeliverynote: function () {
                ...
                var that = this;
                this.form.post('/api/deliverynotes').then(function (response) {
            ...
            printData: function(quote_id){
                ...
                axios.get('/api/print-pdf/delivery_note/'+quote_id)
                    .then((res)=>{
                        that.pdf_link = res.data;
