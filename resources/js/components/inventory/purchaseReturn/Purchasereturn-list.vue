                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <ul class="breadcrumb breadcrumb-style d-inline-block mb-0">
                                <li class="breadcrumb-item">
                                    <h4 style="border: 0;" class="page-title">Purchase Return</h4>
                                </li>
                            </ul>
                            <ul class="d-inline-block mb-0" style="float: right;padding: .75rem 1rem;">
                                <li style="float: left;">
                                    <router-link to="/inventory/purchase-return/create" class="btn btn-default m-0 mr-2 mb-2 mb-lg-0 mobile_d_none">New Purchase Return</router-link>
                                    <router-link to="/inventory/purchase-return/create" class="btn btn-default m-0 mr-2 mb-2 mb-lg-0 mobile_d_block"><i class="fas fa-plus"></i></router-link>
                                </li>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 190px;">Purchase Returns Date</th>
                                        <th style="min-width: 190px;">Purchase Returns NO</th>
                                        <th style="min-width: 155px;">Supplier</th>
                                        <th class="text-right" style="min-width: 120px;">Amount</th>
                                        <th class="text-right" style="min-width: 120px;">Notes</th>
                                        <th class="text-right" style="min-width: 120px;">Delivery Date</th>
