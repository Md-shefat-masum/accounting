                                                                            ...
                                                                            <td class="A54VNK-Ff-a A54VNK-Ff-s A54VNK-Ff-n">
                                                                                <div style="outline-style:none;">
                                                                                    <div class="dropdown">
                                                                                        ...
                                                                                        <ul class="dropdown-menu A54VNK-Yj-a">
                                                                                            <li class="">
                                                                                                <a class="ellipsis-block" role="button">storage.name</a>
                                                                                            </li>
                                                                                        </ul>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div>
                                                                        <div>
                                                                            <div class="form-horizontal">
                                                                                ...
                                                                                <div class="form-group row"style="margin-bottom: 15px !important;">
                                                                                    <div class="col-sm-4 col-4 control-label">
                                                                                        <label class="" style="font-weight: normal;">Expected Delivery</label>
                                                                                    </div>
                                                                                    <div class="col-sm-8 col-8">
                                                                    ...
                                                                    <div>
                                                                        <div>
                                                                            <div class="form-horizontal">
                                                                                ...
                                                                                <div class="form-group row"style="margin-bottom: 15px !important;">
                                                                                    <div class="col-sm-4 col-4 control-label">
                                                                                        <label class="" style="font-weight: normal;">Invoicing Status</label>
                                                                                    </div>
                                                                                    <div class="col-sm-8 col-8">
                                                                                        <div class="A54VNK-ni-a">
                                                                                            <div class="select-panel A54VNK-ni-c">
...
<script>
    ...
    export default {
        ...
        created: function(){
            this.getReceivingnote();
        },
        methods: {
            getReceivingnote: function(Receivingnote){

                var that = this;
                this.form.get('/api/receivingnotes/'+this.$route.params.id).then(function(response){
                    that.form.fill(response.data);
                    that.loaded = true;
                });

            },
            updateReceivingnote: function(){

                var that = this;
                this.form.put('/api/receivingnotes/'+this.$route.params.id).then(function(response){
                    that.form.fill(response.data);
                })

            },
            deleteReceivingnote: function(){

                var that = this;
                this.form.delete('/api/receivingnotes/'+this.$route.params.id).then(function(response){
                    that.form.fill(response.data);
                    that.$router.push('/super-admin/receivingnotes');
                })
