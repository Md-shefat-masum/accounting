                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="table-img">
                                                <img src="/backend/assets/images/user/user1.jpg" alt="">
                                            </td>
                                            <td>John Doe</td>
                                            <td>xyz@email.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="table-img">
                                                <img src="/backend/assets/images/user/user2.jpg" alt="">
                                            </td>
                                            <td>Sarah Smith</td>
                                            <td>xyz@email.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="table-img">
                                                <img src="/backend/assets/images/user/user3.jpg" alt="">
                                            </td>
                                            <td>Airi Satou</td>
                                            <td>xyz@email.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="table-img">
                                                <img src="/backend/assets/images/user/user4.jpg" alt="">
                                            </td>
                                        ...
                                        <tr>
                                            <td class="table-img">
                                                <img src="/backend/assets/images/user/user5.jpg" alt="">
                                            </td>
                                            <td>Ashton Cox</td>
                                            <td>xyz@email.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="table-img">
                                                <img src="/backend/assets/images/user/user6.jpg" alt="">
                                            </td>
                                            <td>Cara Stevens</td>
                                            <td>xyz@email.com</td>
                                            <td>
                                                    ...
                                                    <ul class="list-unstyled order-list">
                                                        <li class="avatar avatar-sm">
                                                            <img class="rounded-circle"
                                                                 src="/backend/assets/images/user/user1.jpg" alt="user">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                                            <img class="rounded-circle"
                                                                 src="/backend/assets/images/user/user2.jpg" alt="user">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                                            <img class="rounded-circle"
                                                                 src="/backend/assets/images/user/user3.jpg" alt="user">
                                                        </li>
                                                        <li class="avatar avatar-sm">
